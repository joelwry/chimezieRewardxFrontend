      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-background shadow-lg border-r z-[100] !bg-background !bg-opacity-100"
            style={
              {
      ...
      >
        ...
        <div
          className={cn(
            ...
            // Collapsed: width 0, transparent, z-0. Expanded: normal width, bg-background, z-10.
            state === "collapsed"
              ? "w-0 bg-transparent z-0"
              : "w-[--sidebar-width] bg-background shadow-lg border-r z-10",
            className
          )}
          {...props}
        >
